...
s.add(x2 == 0)
s.add(x3(0) == x2)
s.add(ForAll(n, Implies(n >= 0, x3(n + 1) == If(x3(n) < 50000, x3(n) + 1, x3(n) + 2))))
########## closed form ##########
s.add(ForAll(n, Implies(n >= 0, x3(n) == If(And(0 <= n, n < 50000), n, 2*n - 50000))))
#################################
s.add(x4 == x3(N0))
s.add(y2(0) == y1)
s.add(ForAll(n, Implies(n >= 0, y2(n + 1) == If(x3(n) < 50000, y2(n), y2(n) + 2))))
########## closed form ##########
s.add(ForAll(n, Implies(n >= 0, y2(n) == If(And(0 <= n, n < 50000), 50000, 2*n - 50000))))
#################################
s.add(y3 == y2(N0))
